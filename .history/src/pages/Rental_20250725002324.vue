  ...
  <div class="flex justify-between gap-2.5 w-full flex-wrap">
    ...
    <div class="flex gap-4 flex-wrap">
      ...
      <div class="flex gap-2.5 flex-wrap">
        <InputField placeHolder="Filtrar data de locação" v-model="rentalDate" typeField="date" styleField="date" placeHolder="Filtrar data de locação"></InputField>
        <InputField placeHolder="Filtrar data de entrega" v-model="deliveryDate" typeField="date" styleField="date" placeHolder="Filtrar data de entrega"></InputField>
