...
const filterText = (e: any) => {
  ...
  filterClient(filterText, clients, clientsStore.clients)
...
const filterSelect = (e: any) => {
  ...
  filterStatus(status, clients, clientsStore.clients)
}
...
<template>
  ...
  <div class="flex justify-between w-full flex-wrap gap-2.5">
    <Title class="w-auto">Clientes</Title>
  ...
  <router-link to="/clients/new" class="w-full md:size-max">
