...
const filterDate = () => {
  ...
  const formattedRentalDate = hasRentalDate ? parseDateString(rentalDate.value) : null;
  const formattedDeliveryDate = hasDeliveryDate ? parseDateString(deliveryDate.value) : null;
  ...
  rentals.value = rentalStore.rentals.filter((registro) => {
    const registroRental = parseDateString(registro.rentalDate);
    const registroDelivery = parseDateString(registro.deliveryDate);
