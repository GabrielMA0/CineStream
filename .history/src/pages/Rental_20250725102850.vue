...
const filterText= (e: any) => {
  ...
  console.log('Antes do filtro:', rentalStore.rentals.length, rentalStore.rentals);
console.log('Antes do filtro rentals.value:', rentals.value.length, rentals.value);

filterClient(filterText, rentals, rentalStore.rentals);

console.log('Depois do filtro rentals.value:', rentals.value.length, rentals.value);
console.log('Depois do filtro rentalStore.rentals:', rentalStore.rentals.length, rentalStore.rentals);
