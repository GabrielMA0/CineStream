  ...
  <div class="flex justify-between gap-2.5 w-full flex-wrap">
    ...
    <div class="flex gap-4 flex-wrap">
      ...
      <div class="flex gap-2.5 flex-wrap">
        <InputField v-model="rentalDate" typeField="date" styleField="date" placeHolder="Filtrar data de locação"></InputField>
        <InputField v-model="deliveryDate" typeField="date" styleField="date" placeHolder="Filtrar data de entrega"></InputField>
