...
const clientEdit = getDataById(client.clients, id) || ({} as ClientData);
...
const { handleSubmit, setFieldValue } = useForm<ClientData>({
...
const onSubmit = handleSubmit((values: ClientData) => {
  const newId = uuidv4();
...
const onUpdate = handleSubmit((values: ClientData) => {
