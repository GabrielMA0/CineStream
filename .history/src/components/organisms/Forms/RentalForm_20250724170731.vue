    ...
    <form @submit.prevent="onSubmit" class="flex flex-col justify-center items-center gap-5">
        <ContainerInputs>
          <div class="relative">
            ...
            <div v-show="showModal" class="absolute bg-[#ffff] w-full p-2.5 rounded-b-[8px] border-1 z-10" v-model="inputClient" @blur="showModal = false">
              <input class="border-1 w-full mb-3 p-2" type="text" @input="searchClient">
              <nav>
