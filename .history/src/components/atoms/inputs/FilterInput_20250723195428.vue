...
<template>
  <div class="relative flex items-center">
    ...
    <select  v-for="value in optionsValue" :key="value.id" name="select" class="outline-none border-none p-[16px] w-full bg-[#242647] text-[#E2E8F0] rounded-[8px] max-w-[448px]">
